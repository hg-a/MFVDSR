...
def test_VDSR_with_sess(ckpt_path, data_path, sess, weights, epo):
	...
	for folder_path in folder_list:
		...
		psnr_file_savepath = "./psnr save file/psnr_epochs_%2depochs.txt"%epo
		psnr_file = open(psnr_file_savepath,'w')
		'''
		psnr_file.write("PSNR: bicubic -> all")
		psnr_file.write("\n")
		psnr_file.write(str(average_bicub))
		psnr_file.write("\n")
		psnr_file.write("PSNR: V D S R -> all")
		psnr_file.write("\n")
		psnr_file.write(str(average_vdsr))
		psnr_file.write("\n")
		psnr_file.write("PSNR: bicubic -> x2")
		psnr_file.write("\n")
		psnr_file.write(str(averagex2_bicub))
		psnr_file.write("\n")
		...
		psnr_file.write("\n")
		psnr_file.write(str(averagex3_bicub))
		psnr_file.write("\n")
		psnr_file.write("PSNR: V D S R -> x3")
		psnr_file.write("\n")
		psnr_file.write(str(averagex3_vdsr))
		psnr_file.write("\n")			
		psnr_file.write("PSNR: bicubic -> x4")
		psnr_file.write("\n")
		psnr_file.write(str(averagex4_bicub))
		psnr_file.write("\n")
		psnr_file.write("PSNR: V D S R -> x4")
		psnr_file.write("\n")
		psnr_file.write(str(averagex4_vdsr))
		'''
...
if __name__ == '__main__':
	with tf.Session() as sess:
		...
		for i in range(start_epo, end_epo+1):
			...
			test_VDSR_with_sess(model_ckpt, DATA_PATH, sess, weights, i)
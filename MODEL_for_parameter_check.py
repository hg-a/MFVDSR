...
def MFVDSR(input_tensor):
	with tf.device("/gpu:0"):
		...
		eve_tensor = None
		beforeReLU_check_tensor = []
		afterReLU_check_tensor = []
		...
		tensor = tf.nn.bias_add(tf.nn.conv2d(input_tensor, conv_w, strides=[1,1,1,1], padding='SAME'), conv_b)
		beforeReLU_check_tensor.append(tensor)
		tensor = tf.nn.relu(tensor)
		afterReLU_check_tensor.append(tensor)
		...
		return tensor, weights, beforeReLU_check_tensor, afterReLU_check_tensor, eve_tensor, input_tensor
